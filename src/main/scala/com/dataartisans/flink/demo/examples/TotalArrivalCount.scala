...
package com.dataartisans.flink.demo.examples
...
object TotalArrivalCount {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val cellIds: DataStream[(Int, Long, Short)] = cleansedRides.map(r =>
    ...
    val passengerCnts: DataStream[(Int, Long, Int)] = cellIds
      ...
      .fold((0, 0L, 0))((s: (Int, Long, Int), r: (Int, Long, Short)) => (r._1, s._2.max(r._2), s._3 + r._3))
  ...
  class CntTimeByLocUpsert(host: String, port: Int) extends ElasticsearchUpsertSink[(Int, Long, GeoPoint, Int)](
    host,
    port,
    "elasticsearch",
    "nyc-idx",
